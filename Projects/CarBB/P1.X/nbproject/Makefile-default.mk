...
SOURCEFILES_QUOTED_IF_SPACED=p1.c clcd.c matrix_keypad.c sub.c adc.c eeprom.c menu.c uart.c External_eeprom.c ds1307.c i2c.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p1.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/matrix_keypad.p1 ${OBJECTDIR}/sub.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/External_eeprom.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/i2c.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/p1.p1.d ${OBJECTDIR}/clcd.p1.d ${OBJECTDIR}/matrix_keypad.p1.d ${OBJECTDIR}/sub.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/eeprom.p1.d ${OBJECTDIR}/menu.p1.d ${OBJECTDIR}/uart.p1.d ${OBJECTDIR}/External_eeprom.p1.d ${OBJECTDIR}/ds1307.p1.d ${OBJECTDIR}/i2c.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p1.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/matrix_keypad.p1 ${OBJECTDIR}/sub.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/External_eeprom.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/i2c.p1

# Source Files
SOURCEFILES=p1.c clcd.c matrix_keypad.c sub.c adc.c eeprom.c menu.c uart.c External_eeprom.c ds1307.c i2c.c
...
${DISTDIR}/P1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/P1.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=0-3000 -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/P1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/P1.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/P1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/P1.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=0-3000 -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/P1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
